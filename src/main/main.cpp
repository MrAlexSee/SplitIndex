...
int handleParams(int argc, const char **argv)
{
    ...
    options.add_options()
       ...
       ("index-type", po::value<string>(&params.indexType)->default_value("k1"), "split index type: k1 (k = 1), k1comp (k = 1 with q-gram compression), k1comptriple (k = 1 with 2-,3-,4-gram compression)")
